...
public class Custom_adapter1 extends BaseExpandableListAdapter {
    List<Books> chapterlist;
    Context context;

    public Custom_adapter1(List<Books> chapterlist, Context  context) {
    ...
    public View getGroupView(int i, boolean isExpanded, View convertView, ViewGroup parent) {
        convertView = LayoutInflater.from(context).inflate(R.layout.books_item,parent,false);
